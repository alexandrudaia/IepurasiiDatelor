...
output = pd.DataFrame({'id': id_test, 'price_doc2':average})
output.head()

output_train=pd.DataFrame({'price_doc2':averageTrain})
output.to_csv('predictionTrain2.csv',index=False)


# In[97]:

output.to_csv('predictionTest2.csv', index=False)
