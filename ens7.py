...
output = pd.DataFrame({'id': id_test, 'price_doc7':average})
output.head()

output_train=pd.DataFrame({'price_doc7':averageTrain})
output.to_csv('predictionTrain7.csv',index=False)


# In[97]:

output.to_csv('predictionTest7.csv', index=False)
