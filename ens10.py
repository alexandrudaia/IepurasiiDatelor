...
output = pd.DataFrame({'id': id_test, 'price_doc10':average})
output.head()

output_train=pd.DataFrame({'price_doc10':averageTrain})
output.to_csv('predictionTrain10.csv',index=False)


# In[97]:

output.to_csv('predictionTest10.csv', index=False)
