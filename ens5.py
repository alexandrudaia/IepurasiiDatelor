...
output = pd.DataFrame({'id': id_test, 'price_doc5':average})
output.head()

output_train=pd.DataFrame({'price_doc5':averageTrain})
output.to_csv('predictionTrain5.csv',index=False)


# In[97]:

output.to_csv('predictionTest4.csv', index=False)
