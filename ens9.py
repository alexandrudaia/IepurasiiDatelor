...
output = pd.DataFrame({'id': id_test, 'price_doc9':average})
output.head()

output_train=pd.DataFrame({'price_doc9':averageTrain})
output.to_csv('predictionTrain9.csv',index=False)


# In[97]:

output.to_csv('predictionTest9.csv', index=False)
