...
output = pd.DataFrame({'id': id_test, 'price_doc15':average})
output.head()

output_train=pd.DataFrame({'price_doc15':averageTrain})
output.to_csv('predictionTrain15.csv',index=False)


# In[97]:

output.to_csv('predictionTest15.csv', index=False)
