...
output = pd.DataFrame({'id': id_test, 'price_doc13':average})
output.head()

output_train=pd.DataFrame({'price_doc13':averageTrain})
output.to_csv('predictionTrain13.csv',index=False)


# In[97]:

output.to_csv('predictionTest13.csv', index=False)
