...
output = pd.DataFrame({'id': id_test, 'price_doc3':average})
output.head()

output_train=pd.DataFrame({'price_doc3':averageTrain})
output.to_csv('predictionTrain3.csv',index=False)


# In[97]:

output.to_csv('predictionTest3.csv', index=False)
