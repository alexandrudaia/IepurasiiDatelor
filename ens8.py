...
output = pd.DataFrame({'id': id_test, 'price_doc8':average})
output.head()

output_train=pd.DataFrame({'price_doc8':averageTrain})
output.to_csv('predictionTrain8.csv',index=False)


# In[97]:

output.to_csv('predictionTest8.csv', index=False)
