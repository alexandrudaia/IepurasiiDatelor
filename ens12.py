...
output = pd.DataFrame({'id': id_test, 'price_doc12':average})
output.head()

output_train=pd.DataFrame({'price_doc12':averageTrain})
output.to_csv('predictionTrain12.csv',index=False)


# In[97]:

output.to_csv('predictionTest12.csv', index=False)
