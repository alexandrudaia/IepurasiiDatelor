...
output = pd.DataFrame({'id': id_test, 'price_doc6':average})
output.head()

output_train=pd.DataFrame({'price_doc6':averageTrain})
output.to_csv('predictionTrain6.csv',index=False)


# In[97]:

output.to_csv('predictionTest6.csv', index=False)
